<div>
    <form wire:submit.prevent="handle">
        <table class="table-fixed border-collapse w-1/2">
            <thead>
            <tr>
                <th class="w-1/3 p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">Template Column</th>
                <th class="w/2/3 p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">CSV Column</th>
            </tr>
            </thead>
            <tbody>
